...
async def reply_with_payment_proof(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.effective_chat.type in [
        ...
        user_caption = (
            ...
            f"Congrats🎉, the deposit you made <b>{format_amount(d_order.amount)} AED</b> has been approved.\n"
            f"{f'plus <b>{format_amount(gifts_amount)}</b> gift for reaching <b>1,000,000A</b> deposits.' if gifts_amount else ''}\n\n"
